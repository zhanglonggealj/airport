...
@Table(name = "t_day_money_residue")
public class TDayMoneyResidue extends BaseModel {

  private static final long serialVersionUID = -6703664028167537083L;
  @Id
  private Long id;
